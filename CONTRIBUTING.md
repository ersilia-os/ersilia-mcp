...
We welcome the use of AI assistants (such as GitHub Copilot, ChatGPT, or Claude) to help write code, optimize logic, or draft documentation.

To maintain high code quality and respect the time of our maintainers, we ask that you follow these guidelines when using AI:

* You are fully responsible for your submission. Please ensure you thoroughly understand, test, and feel confident explaining all the code you submit.
...
1. Comment on the issue to let others know you're working on it. This helps avoid duplicate work. You can also ask questions about the issue if anything is unclear.
2. Fork the repository
3. Make changes in your fork (or in a branch of your fork)
4. Create a Pull Request (PR) with a description of the changes made. A good description really helps the community managers. Link the issue the PR is related to as well.
5. PR's have automated tests. If the tests fail, please make the necessary changes. Ersilia maintainers will only work on PRs that pass the tests.
